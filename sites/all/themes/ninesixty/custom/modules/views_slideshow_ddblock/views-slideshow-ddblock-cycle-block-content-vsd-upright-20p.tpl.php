         ...
         <?php if ($settings['slide_text'] == 1) :?>
          <div class="slide-text slide-text-<?php print $settings['slide_direction'] ?> slide-text-<?php print $settings['slide_text_position'] ?> clear-block border">
           ...
           <div class="slide-text-inner clear-block border">
            ...
            <div class="slide-body-inner-text clear-block border">   <?php print $slider_item['slide_text'] ?></div>
<div class="slide-body-inner-location clear-block border"><?php print $slider_item['slide_location'] ?></div>
<div class="slide-body-inner-status clear-block border"><?php print $slider_item['slide_status'] ?></div>
